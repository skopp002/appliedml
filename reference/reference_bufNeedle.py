...
NEEDLE_LENGTH = 2  # length of needle; uses same "units" as bound and floorbaord width
FLOORBOARD_WIDTH = 3 # sapcing between floorbaord lines (twice needle length works out nicely for pi approximation)
...
class Buffon_Sim:
    ...
    def __init__(self):
        ...
        # Setup plot
        fig = plt.figure(figsize=(10, 10))  # size of window large enough to view plot details
